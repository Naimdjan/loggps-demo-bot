...
// Вернул дату и время для алертов
const getTjTime = () => {
...
app.post("/telegram", async (req, res) => {
  ...
  if (msg?.text?.startsWith("/start")) {
    const keyboard = [
      ...
      [{ text: "🌐 Открыть платформу web", callback_data: "GO_PLATFORM" }],
      [{ text: "📲 Скачать для Android", callback_data: "GO_ANDROID" }],
      [{ text: "📱 Скачать для iOS", callback_data: "GO_IOS" }]
    ];
